...
class _PinchZoomImageState extends State<PinchZoomImage> {
  ...
  GlobalKey<_PinchZoomOverlayImageState> overlayKey = GlobalKey();
...
class PinchZoomOverlayImage extends StatefulWidget {
  ...
  @override
  _PinchZoomOverlayImageState createState() => _PinchZoomOverlayImageState();
}

class _PinchZoomOverlayImageState extends State<PinchZoomOverlayImage>
